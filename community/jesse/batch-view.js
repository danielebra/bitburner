...
export async function main(ns) {
  ...
  if (flags.help) {
    ns.tprint([`USAGE`, `> run ${ns.getScriptName()} --port 10`, " "].join("\n"));
    return;
  }
  ...
  render() {
    return React.createElement(
      ...
      React.createElement(SecurityLayer, {
        ...
        observedServers: this.observedServers,
      }),
...
function GraphFrame({ now, children }) {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "clipPath",
        { id: `hide-future-${initTime}`, clipPathUnits: "userSpaceOnUse" },
        React.createElement("rect", {
          id: "hide-future-rect",
          x: convertTime(now - 60000),
          width: convertTime(60000, 0),
          y: 0,
          height: 50,
        }),
      ),
    ...
    React.createElement("rect", {
      ...
      width: "100%",
      height: "100%",
      fill: GRAPH_COLORS.safe,
    }),
    React.createElement(
      "g",
      {
        id: "timeCoordinates",
        transform: `scale(${WIDTH_PIXELS / WIDTH_SECONDS} 1) translate(${convertTime(initTime - now, 0)} 0)`,
      },
      children,
    ),
...
function GraphLegend() {
  return React.createElement(
    "g",
    { id: "Legend", transform: "translate(-490, 10), scale(.5, .5)" },
    ...
    Object.entries(GRAPH_COLORS).map(([label, color], i) =>
      React.createElement(
        "g",
        { key: label, transform: `translate(22, ${13 + 41 * i})` },
        React.createElement("rect", { x: 0, y: 0, width: 22, height: 22, fill: color }),
        React.createElement(
          "text",
          { fontFamily: "Courier New", fontSize: 36, fill: "#888" },
  ...
  return React.createElement(
    ...
    expectedServers.map((server, i) => {
      ...
      if (prevServer && server.time > prevServer.time) {
        el = React.createElement("rect", {
          key: i,
          x: convertTime(prevServer.time),
          width: convertTime(server.time - prevServer.time, 0),
          y: 0,
          height: "100%",
...
function JobLayer({ jobs }) {
  return React.createElement(
    "g",
    { id: "jobLayer" },
    jobs.map((job) => React.createElement(JobBar, { job: job, key: job.jobID })),
  );
}
function JobBar({ job }) {
  ...
  if (job.startTime && job.duration) {
    jobBar = React.createElement("rect", {
  ...
  if (job.startTimeActual) {
    ...
    startErrorBar = React.createElement("rect", {
      x: convertTime(t1),
  ...
  if (job.endTimeActual) {
    ...
    endErrorBar = React.createElement("rect", {
      x: convertTime(t1),
      width: convertTime(t2 - t1, 0),
      y: 0,
      height: 1,
  ...
  return React.createElement("g", { transform: `translate(0 ${y})` }, jobBar, startErrorBar, endErrorBar);
}
function SecurityLayer({ expectedServers, observedServers }) {
  ...
  const observedLayer = React.createElement(
    "g",
    {
      id: "observedSec",
  ...
  const expectedLayer = React.createElement(
    "g",
    {
      id: "expectedSec",
      transform: `translate(0 ${FOOTER_PIXELS}) scale(1 ${-FOOTER_PIXELS / (maxSec - minSec)})`,
  ...
  return React.createElement(
    "g",
    { id: "secLayer", transform: `translate(0 ${HEIGHT_PIXELS - 2 * FOOTER_PIXELS})` },
    observedLayer,
    expectedLayer,
  );
}
...
function MoneyLayer({ expectedServers, observedServers }) {
  ...
  return React.createElement(
    "g",
    { id: "moneyLayer", transform: `translate(0 ${HEIGHT_PIXELS - FOOTER_PIXELS})` },
    observedLayer,
    expectedLayer,
  );
}
